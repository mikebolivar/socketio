	...
	render: function () {
		return (
			<div className="comment">
				...
				<CommentBoxUpdate url={ "https://stark-shore-49013.herokuapp.com/api/product/" +  this.props.product.id + "/comments/"} product = {this.props.product.id} pollInterval="10000"/>
			</div>
		);
	}
});
